	...
	<div class="card card-bordered border-gray-300 w-full shadow-lg pt-4 pb-2">
		...
		<div class="px-8">
			<div class="flex">
				...
				<svg xmlns="http://www.w3.org/2000/svg" fill="@if($post->userLiked($user))currentColor
					@else
					none
					@endif
					" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 @if($post->userLiked($user))
					text-primary
					@endif">
